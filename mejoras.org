...
*** con el modulo nuevo
    ...
    68992     112   24820   93924   16ee4 Magneto_GTK_rom.elf      

*** comunicacion desde la placa de antena 
    - manda el mensaje de conexion 1 ves por segundo hasta estar conectada
    - despues si no recibe nada a los 10 segs aprox lo vuelve a mandar
    - en el medio si esta en conexion no manda nada solo contesta lo que se le pregunta
