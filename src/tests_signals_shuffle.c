...
void Tests_Parameters_Calculate (void);
void Tests_Always_Generate_Parameters_Calculate (void);
void Tests_Always_Generate_Parameters_Calculate_Shuffle (void);
...
{
    // Tests_Parameters_Calculate ();
    // Tests_Always_Generate_Parameters_Calculate ();
    Tests_Always_Generate_Parameters_Calculate_Shuffle ();
...
void Tests_Parameters_Calculate (void)
{
    printf("Parameters Calculations...\n");
...
void Tests_Always_Generate_Parameters_Calculate (void)
{
    ...
    if (i == FIN_OK)
    {
        if ((ini != session_ch_1.stage_1_initial_power) ||
            (fin != session_ch_1.stage_1_final_power))
        {
            printf ("power change initial: %d to %d final: %d to %d\n",
                    ini,
...
int know_antenna = 0;
int TSP_Get_Know_Antennas (session_typedef * p)
{
    int more_antennas = 1;
    ...
    case 0:
        ...
        p->ant_resistance_int = 12;
        p->ant_resistance_dec = 27;
        p->ant_inductance_int = 87;
        p->ant_inductance_dec = 90;
        p->ant_current_limit_int = 1;
        p->ant_current_limit_dec = 80;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
        know_antenna++;
        break;
    ...
    case 1:
        ...
        // const char s_name [] = { "name:Plannar 5 inches\r\n" };
        printf("\nname:Plannar 5 inches\n");
        p->ant_resistance_int = 23;
        p->ant_resistance_dec = 85;
        p->ant_inductance_int = 141;
        p->ant_inductance_dec = 60;
        p->ant_current_limit_int = 1;
        p->ant_current_limit_dec = 30;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
        know_antenna++;
        break;
    ...
    case 2:
        ...
        // const char s_name [] = { "name:Plannar 5 inches\r\n" };
        printf("\nname:Plannar 5 inches\n");
        p->ant_resistance_int = 17;
        p->ant_resistance_dec = 00;
        p->ant_inductance_int = 120;
        p->ant_inductance_dec = 00;
        p->ant_current_limit_int = 1;
        p->ant_current_limit_dec = 30;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
    ...
    case 3:
        ...
        printf("\nname:Wrist Tunnel\n");
        p->ant_resistance_int = 5;
        p->ant_resistance_dec = 70;
        p->ant_inductance_int = 11;
        p->ant_inductance_dec = 10;
        p->ant_current_limit_int = 2;
        p->ant_current_limit_dec = 80;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
        know_antenna++;
    ...
    case 4:
        ...
        p->ant_resistance_int = 3;
        p->ant_resistance_dec = 50;
        p->ant_inductance_int = 19;
        p->ant_inductance_dec = 00;
        p->ant_current_limit_int = 3;
        p->ant_current_limit_dec = 50;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
        know_antenna++;
        break;
    ...
    case 5:
        ...
        p->ant_resistance_int = 4;
        p->ant_resistance_dec = 00;
        p->ant_inductance_int = 22;
        p->ant_inductance_dec = 60;
        p->ant_current_limit_int = 3;
        p->ant_current_limit_dec = 50;
        p->ant_temp_max_int = 65;
    ...
    case 6:
        ...
        p->ant_resistance_int = 2;
        p->ant_resistance_dec = 50;
        p->ant_inductance_int = 21;
        p->ant_inductance_dec = 00;
        p->ant_current_limit_int = 3;
        p->ant_current_limit_dec = 50;
        p->ant_temp_max_int = 65;
    ...
    case 7:
        ...
        // const char s_name [] = { "name:Tunnel 10 inches\r\n" };
        printf("\nname:Tunnel 10 inches\n");
        p->ant_resistance_int = 6;
        p->ant_resistance_dec = 60;
        p->ant_inductance_int = 56;
        p->ant_inductance_dec = 50;
        p->ant_current_limit_int = 3;
        p->ant_current_limit_dec = 50;
        p->ant_temp_max_int = 65;
        p->ant_temp_max_dec = 0;
    ...
    case 8:
        ...
        // const char s_name [] = { "name:Tunnel 10 inches\r\n" };
        printf("\nname:Tunnel 10 inches\n");
        p->ant_resistance_int = 10;
        p->ant_resistance_dec = 10;
        p->ant_inductance_int = 128;
        p->ant_inductance_dec = 10;
        p->ant_current_limit_int = 3;
        p->ant_current_limit_dec = 50;
        p->ant_temp_max_int = 65;
    ...
    case 9:
        ...
        printf("\nname:GT Googles\n");
        p->ant_resistance_int = 61;
        p->ant_resistance_dec = 0;
        p->ant_inductance_int = 63;
        p->ant_inductance_dec = 0;
        p->ant_current_limit_int = 0;
        p->ant_current_limit_dec = 64;
        p->ant_temp_max_int = 55;
        p->ant_temp_max_dec = 0;
        know_antenna++;
        break;
    ...
    // set some time
    p->stage_1_time_hours = 1;
    p->stage_1_time_minutes = 0;
    p->stage_1_time_seconds = 0;
    // set max power
    p->stage_1_initial_power = 100;
    p->stage_1_final_power = 100;
    p->stage_1_time_per_step = 0;
...
int know_signals = 0;
int TSP_Get_Know_Signals (session_typedef * p)
{
    int more_signals = 1;
    ...
    switch (know_signals)
    {
        ...
        // FREQ_86_22_HZ
    case 0:    
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_7_83_HZ, p);
        know_signals++;
        break;

    case 1:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_11_79_HZ, p);
        know_signals++;
        break;

    case 2:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_16_67_HZ, p);
        know_signals++;
        break;

    case 3:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_23_58_HZ, p);
        know_signals++;
        break;

    case 4:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_30_80_HZ, p);
        know_signals++;
        break;

    case 5:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_62_64_HZ, p);
        know_signals++;
        break;

    case 6:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_0_98_HZ, p);
        know_signals++;
        break;

    case 7:
        TSP_Get_Signal_Times_From_Screen(SQUARE_SIGNAL, FREQ_86_22_HZ, p);
        know_signals++;
        break;
    ...
    case 8:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_7_83_HZ, p);
        know_signals++;
        break;

    case 9:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_11_79_HZ, p);
        know_signals++;
        break;

    case 10:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_16_67_HZ, p);
        know_signals++;
        break;

    case 11:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_23_58_HZ, p);
        know_signals++;
        break;

    case 12:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_30_80_HZ, p);
        know_signals++;
        break;

    case 13:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_62_64_HZ, p);
        know_signals++;
        break;

    case 14:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_0_98_HZ, p);
        know_signals++;
        break;

    case 15:
        TSP_Get_Signal_Times_From_Screen(TRIANGULAR_SIGNAL, FREQ_86_22_HZ, p);
        know_signals++;
        break;
    ...
    case 16:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_7_83_HZ, p);
        know_signals++;
        break;

    case 17:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_11_79_HZ, p);
        know_signals++;
        break;

    case 18:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_16_67_HZ, p);
        know_signals++;
        break;

    case 19:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_23_58_HZ, p);
        know_signals++;
        break;

    case 20:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_30_80_HZ, p);
        know_signals++;
        break;

    case 21:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_62_64_HZ, p);
        know_signals++;
        break;

    case 22:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_0_98_HZ, p);
        know_signals++;
        break;

    case 23:
        TSP_Get_Signal_Times_From_Screen(SINUSOIDAL_SIGNAL, FREQ_86_22_HZ, p);
        know_signals++;
        break;
...
{
    int loop_cnt = 0;
    int loop_signals_end = 0;
    
    printf("Parameters Calculations with Power Control...\n");
    printf(" All know antennas with all know signals\n");    

    while (1)        
    {
        if (TSP_Get_Know_Antennas (&session_ch_1) == 0)
            break;
        ...
        while (1)
        {
            if (TSP_Get_Know_Signals (&session_ch_1) == 0)
                break;

            unsigned char i = 0;

            // get the setted power and backup
            unsigned char ini = session_ch_1.stage_1_initial_power;
            unsigned char fin = session_ch_1.stage_1_final_power;
            ...
            // restore power backup
            session_ch_1.stage_1_initial_power = ini;
            session_ch_1.stage_1_final_power = fin;
            
            printf ("Loop %d Test result: ", loop_cnt);
            if (i == FIN_OK)
                PrintOK();
            else
                PrintERR ();
...
void TSP_Get_Signal_Times_From_Screen_Square (freq_value_e freq, session_typedef * psession)
{
    ...
    case FREQ_0_98_HZ:
        ...
        psession->stage_1_maintenance_time = 498;
        psession->stage_1_falling_time = 1;
        psession->stage_1_low_time = 500;
        break;
    ...
    case FREQ_86_22_HZ:
        psession->stage_1_rising_time = 1;
        psession->stage_1_maintenance_time = 4;
        psession->stage_1_falling_time = 1;
        psession->stage_1_low_time = 6;
        break;
...
void TSP_Get_Signal_Times_From_Screen_Triangular (freq_value_e freq, session_typedef * psession)
{
    ...
    {
    case FREQ_0_98_HZ:
        psession->stage_1_rising_time = 498;
    ...
    case FREQ_86_22_HZ:
        psession->stage_1_rising_time = 4;
        psession->stage_1_maintenance_time = 1;
        psession->stage_1_falling_time = 1;
        psession->stage_1_low_time = 6;            
        break;
...
void TSP_Get_Signal_Times_From_Screen_Sinusoidal (freq_value_e freq, session_typedef * psession)
{
    ...
    {
    case FREQ_0_98_HZ:
        psession->stage_1_rising_time = 166;
        psession->stage_1_maintenance_time = 167;
        psession->stage_1_falling_time = 166;
        psession->stage_1_low_time = 500;
        break;
    ...
    case FREQ_86_22_HZ:
        psession->stage_1_rising_time = 2;
        psession->stage_1_maintenance_time = 2;
        psession->stage_1_falling_time = 2;
        psession->stage_1_low_time = 6;            
        break;
